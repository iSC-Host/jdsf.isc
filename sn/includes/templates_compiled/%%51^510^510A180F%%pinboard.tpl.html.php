<?php /* Smarty version 2.6.26, created on 2014-03-11 21:22:17
         compiled from file:style/newcunity/templates/pinboard.tpl.html */ ?>
...
<div class="bar">
    ...
    <div class="bar-sub-b">
        <h1 id="dsf"><?php echo $this->_tpl_vars['pinboard_header']; ?>
</h1>
    </div>
...
<div class="box-main-a-2 options-a-2 buttonset">
    <input type="radio" icon="ui-icon-signal-diag" id="show_all"class="jui-button" name="sort"checked="checked" onclick="loadPinboard('all')"/><label for="show_all"><?php echo $this->_tpl_vars['pinboard_all']; ?>
</label><input type="radio" id="show_status" icon="ui-icon-comment" name="sort"class="jui-button" onclick="loadPinboard('status')"/><label for="show_status"><?php echo $this->_tpl_vars['pinboard_status_updates']; ?>
</label><input type="radio" id="show_videos" icon="ui-icon-video"name="sort" class="jui-button" onclick="loadPinboard('video')"/><label for="show_videos"><?php echo $this->_tpl_vars['pinboard_videos']; ?>
</label><input type="radio" id="show_images" icon="ui-icon-image" name="sort"class="jui-button" onclick="loadPinboard('image')"/><label for="show_images"><?php echo $this->_tpl_vars['pinboard_photos']; ?>
</label>        
</div>
            ...
            <div id="img_upload_container" style="border-top: 1px dashed #ccc;">
                <form action="controllers/ajaxPinboardController.php" target="imgUploadFrame" id="imgUploadForm" style="width: 490px; padding: 3px 5px;" enctype="multipart/form-data" method="post">
                    <div id="imgUploadFormLeft" style="float: left; width: 250px">
                        <label for="pinimg"><small><?php echo $this->_tpl_vars['pinboard_select_image']; ?>
</small></label>
                        <br/>
...
","c":"imgUpload"}'/>
                    ...
                    <small style="color: #aaa; display:block" class="clear"><?php echo $this->_tpl_vars['pinboard_image_upload_info']; ?>
</small>
                </form>
            </div>                
        </div>
...
"><img src="style/newcunity/img/upload_file.png" style="padding: 3px;"/></a> -->
    ...
    <div id="share_button_wrap" style="display: none;">
        <div class="box-main-a-sub-1">
            <div class="comment-share-btn" style="width:200px">
                <button id="share_button" class="jui-button" style="float:right;font-size:12px" onclick="shareStatus();"><?php echo $this->_tpl_vars['pinboard_share']; ?>
</button>
                <img id="watermark_loader" src="style/newcunity/img/loading.gif" style="float:right; margin: 5px 10px; display: none;"/>

                <!--  <button icon="ui-icon-gear" class="jui-button" icon2="ui-icon-triangle-1-s" text="0" style="float:left;font-size:12px"><?php echo $this->_tpl_vars['pinboard_share_settings']; ?>
</button>-->     
